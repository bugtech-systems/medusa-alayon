...
import { DynamicQuery } from "../../../types/dynamic-query"
import DynamicQueryService from "../../../modules/dynamic-query/service"
...
export async function POST(
  ...
  try {
     const { entity, ...query } = req.body as {
      entity: string
    } & DynamicQuery
...
export async function GET(
  ...
  try {
    const dynamicQueryService = req.scope.resolve<DynamicQueryService>("dynamicQueryService")

...
const FieldEditorDrawer = ({
  ...
  const [editedField, setEditedField] = useState<any>(
    field ||  { name: '', defaultValue: '', description: '', type: 'string', required: false } 
  )
  ...
  const handleClose = () => {
    setEditedField({ name: '', defaultValue: '', description: '', type: 'string', required: false })
    setErrors({})
    onOpenChange(false)
  }
  ...
  console.log(field, editedField, 'FIEELD')
